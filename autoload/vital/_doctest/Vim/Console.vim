...
execute join(['function! vital#_doctest#Vim#Console#import() abort', printf("return map({'info': '', 'select': '', 'echo': '', 'ask': '', 'echomsg': '', '_vital_created': '', 'debug': '', 'warn': '', 'inputlist': '', '_vital_healthcheck': '', 'input': '', 'confirm': '', 'error': '', 'echon': ''}, \"vital#_doctest#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:t_string = type('')
