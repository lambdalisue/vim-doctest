...
execute join(['function! vital#_doctest#Async#Promise#import() abort', printf("return map({'resolve': '', 'all': '', 'race': '', 'noop': '', 'is_promise': '', 'is_available': '', 'reject': '', 'new': ''}, \"vital#_doctest#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
